...
async function init() {
	...
	let navHTML = "<a href='index.html?lan=" + lan + "'> ← ドラガリのはじめかた！</a> | <form action='comic.html'><input type='number' name='no' placeholder='Jump to Comic...' pattern='[0-9]+'><input type='hidden' name='lan' value='" + lan + "'></form>"
